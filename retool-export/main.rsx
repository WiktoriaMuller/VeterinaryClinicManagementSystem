<App>
  ...
  <Include src="./src/visitsPage.rsx" />
  <CustomAppTheme
    id="$appTheme"
    _migrated={true}
    automatic={[
    ...
    warning="#cd6f00"
  />
  <Include src="./src/addPetForm.rsx" />
  <Include src="./src/addVisitForm.rsx" />
  <Include src="./src/petsPage.rsx" />
  <Include src="./src/employeesPage.rsx" />
  <Include src="./src/addVetForm.rsx" />
</App>
